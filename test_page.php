...
<div class="logo"><img src="https://d2j6dbq0eux0bg.cloudfront.net/images/33513499/1604831850.jpg" alt="Hooghly Mart"></div>
<h1>Hooghly Mart</h1>
<p>We clean & wash with care so that they can be used directly. No more stinky hands cleaning fishes.</p>
<p>Free home delivery: Konnagar to Baidyabati

See menu</p>
<button type="button" class="btn " style="background-color: rgba(254, 217, 119, 1.0);">See menu</button>
</div>
</div>
...
<div class="jumbotron text-center" style="margin-bottom:0">
  ...
  <p>© Hooghly Mart. Cover image by <a href="#">Caroline Attwood</a> from <a href="#">Unsplash</a></p>
	...
	<a href="#" class='fab fa-facebook-messenger' style='font-size:36px'></a>
	</div>
